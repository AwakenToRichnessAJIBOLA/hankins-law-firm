        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-300 hover:text-teal-300 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/practice-areas" className="text-gray-300 hover:text-teal-300 transition-colors">
                  Practice Areas
                </Link>
              </li>
              <li>
                <Link to="/attorneys" className="text-gray-300 hover:text-teal-300 transition-colors">
                  Our Attorneys
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-teal-300 transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-teal-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-4 mb-4 md:mb-0">
              <Button variant="ghost" size="icon" className="text-gray-300 hover:text-teal-300">
            ...
            <div className="text-center md:text-right text-gray-300 text-sm">
              ...
              <p className="mt-1">
                ...
                <Link to="/disclaimer" className="hover:text-teal-300">Legal Disclaimer</Link>
              </p>
            </div>
          </div>
        </div>
