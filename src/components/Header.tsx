        ...
        <div className="flex items-center justify-between h-16 sm:h-20 md:h-24 lg:h-32">
          ...
          <Link to="/" className="flex items-center space-x-3 group flex-shrink-0">
            <img
              ...
              className="h-10 w-10 sm:h-16 sm:w-16 md:h-24 md:w-24 lg:h-32 lg:w-32 object-contain group-hover:scale-105 transition-transform flex-shrink-0"
            />
            <div className="min-w-0 flex-shrink">
              <h1 className="font-display font-bold text-sm sm:text-lg md:text-xl lg:text-2xl text-teal-800 group-hover:text-teal-600 transition-colors leading-tight whitespace-nowrap">
                Hankins Law Firm
              </h1>
              <p className="text-xs sm:text-sm text-teal-600 leading-tight whitespace-nowrap hidden sm:block">
          ...
          <button
            ...
            className="lg:hidden text-teal-800 flex-shrink-0 p-2"
          >
