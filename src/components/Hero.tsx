...
const Hero = () => {
  return (
    <section className="relative min-h-[70vh] md:h-[90vh] flex items-center justify-center animate-fade-in">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 to-blue-600/50 z-10"></div>
      <div
      ...
      <div className="relative z-20 text-center text-white max-w-4xl mx-auto px-4 animate-slide-up">
        <h1 className="font-display text-5xl md:text-7xl font-bold mb-6 leading-tight drop-shadow-xl">
          ...
          <span className="block text-blue-300">Protecting Your Rights.</span>
        </h1>
        <p className="text-xl md:text-2xl mb-8 text-blue-50/80 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/contact" className="hover-scale">
            <Button size="lg" className="blue-gradient text-white font-bold text-lg px-8 py-4 shadow-md hover:opacity-90">
          ...
          <Link to="/about" className="hover-scale">
            <Button
              size="lg"
              variant="outline"
              className="text-white border-white hover:bg-white hover:text-blue-900 text-lg px-8 py-4 shadow"
            >
